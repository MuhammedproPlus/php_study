									...
									<div class="product-custom"  data-aos="fade-down" data-aos-duration="2000">
										<div class="profile-widget">
											...
											<div class="pro-content">
												...
												<p><i class="feather-map-pin"></i>kothamangalam</p>
												<!-- <ul class="d-flex details"> -->
													<!-- <li>
														<img src="assets/img/icons/bed-icon.svg" alt="bed-icon" >
														wifi
												...
												<ul class="property-category d-flex justify-content-between align-items-center">
													<li class="user-info">
														...
														<div class="user-name">
															<h6><a href="rent-details.html">arun</a></h6>
															<p>kothamangalam</p>
														</div>													
													</li>
													<li>
									...
									<div class="product-custom"  data-aos="fade-down" data-aos-duration="2000">
										<div class="profile-widget">
											...
											<div class="pro-content">
												...
												<p><i class="feather-map-pin"></i> nellikuzhi</p>
												<!-- <ul class="d-flex details"> -->
													<!-- <li>
														<img src="assets/img/icons/bed-icon.svg" alt="bed-icon" >
														wifi
									...
									<div class="product-custom"  data-aos="fade-down" data-aos-duration="2000">
										<div class="profile-widget">
											...
											<div class="pro-content">
												...
												<p><i class="feather-map-pin"></i> perumbavoor</p>
												<!-- <ul class="d-flex details">
													<li>
														<img src="assets/img/icons/bed-icon.svg" alt="bed-icon" >
														wifi
									...
									<div class="product-custom"  data-aos="fade-down" data-aos-duration="2000">
										<div class="profile-widget">
											...
											<div class="pro-content">
												...
												<p><i class="feather-map-pin"></i>irumalapady</p>
												<!-- <ul class="d-flex details">
													<li>
														<img src="assets/img/icons/bed-icon.svg" alt="bed-icon" >
														wifi
									...
									<div class="product-custom"  data-aos="fade-down" data-aos-duration="2000">
										<div class="profile-widget">
											...
											<div class="pro-content">
												...
												<p><i class="feather-map-pin"></i> kuruppampady</p>
												<!-- <ul class="d-flex details">
													<li>
														<img src="assets/img/icons/bed-icon.svg" alt="bed-icon" >
														wifi
									...
									<div class="product-custom"  data-aos="fade-down" data-aos-duration="2000">
										<div class="profile-widget">
											...
											<div class="pro-content">
												...
												<p><i class="feather-map-pin"></i>vengola</p>
												<!-- <ul class="d-flex details">
													<li>
														<img src="assets/img/icons/bed-icon.svg" alt="bed-icon" >
														wifi
						...
						<div class="row justify-content-center">
							...
							<!-- <div class="col-lg-4 col-md-6"  data-aos="fade-down" data-aos-duration="2000">
								<div class="single-property-card">
									...
									<div class="buy-property">
										<h4><a href="rent-property-gridhtml">Sell a Property</a></h4>
